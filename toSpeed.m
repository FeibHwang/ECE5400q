...
if 1
    ...
    L= (v*5280/3600/60).*on; % find the vehicle length for each vehicle passage in ft
    t= pd(2:2:end,2,:); % find the time the vehicle passed the dual detector, in 1/60 sec after midnight
elseif 1
